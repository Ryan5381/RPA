    ...
    <div className="lg:col-span-2 border border-slate-200 dark:border-slate-800/80 bg-card/80 dark:bg-background/40 hover:border-cyan-500/40 rounded-xl p-6 relative overflow-hidden shadow-md dark:shadow-lg flex flex-col justify-between">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-900/80 border border-slate-300 dark:border-slate-700/80 text-slate-900 dark:text-slate-200 px-3.5 py-2.5 rounded-lg text-sm font-mono focus:outline-none focus:border-cyan-500 dark:focus:border-cyan-400 focus:ring-1 focus:ring-cyan-500/50 dark:focus:ring-cyan-400/50 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-900/80 border border-slate-300 dark:border-slate-700/80 text-slate-900 dark:text-slate-200 px-3.5 py-2.5 rounded-lg text-sm focus:outline-none focus:border-cyan-500 dark:focus:border-cyan-400 focus:ring-1 focus:ring-cyan-500/50 dark:focus:ring-cyan-400/50 transition-all"
              />
            </div>
          </div>
          ...
          {/* 右側：安全設定與 2FA */}
          <div className="space-y-4">
            <div className="bg-slate-100/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-4 flex items-center justify-between gap-3">
              <div className="min-w-0">
                <div className="text-xs text-slate-500 dark:text-slate-400 font-medium mb-1">
                  API 密鑰管理
                </div>
                <div className="font-mono text-xs sm:text-sm text-slate-800 dark:text-slate-300 tracking-wider truncate">
              ...
              <button
                ...
                className="text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 text-xs font-bold font-mono tracking-wide cursor-pointer transition-colors px-2.5 py-1.5 rounded-md bg-cyan-100/60 dark:bg-cyan-950/40 border border-cyan-400/50 dark:border-cyan-800/50 hover:bg-cyan-200/60 dark:hover:bg-cyan-900/50 shrink-0 flex items-center gap-1.5"
              >
                <RefreshCw
            ...
            <div className="bg-slate-100/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-4 flex items-center justify-between">
              <div>
