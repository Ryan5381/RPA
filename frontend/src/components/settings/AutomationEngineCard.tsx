          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-900/80 border border-slate-700/80 text-slate-200 px-3.5 py-2 rounded-lg text-sm font-mono focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/50 transition-all"
              />
            </div>
          ...
          <div className="space-y-4 flex flex-col justify-between">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-900/80 border border-slate-700/80 text-slate-300 font-mono text-xs p-3 rounded-lg h-[92px] resize-none leading-relaxed focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/50 transition-all"
              />
            </div>
          </div>
        </div>
