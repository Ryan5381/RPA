    ...
    <div className="bg-slate-900/40 border border-slate-800/80 rounded-xl p-6 backdrop-blur-xl flex flex-col h-full justify-between">
      <div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Badge
            variant="outline"
            className="text-[10px] font-mono bg-cyan-950/50 text-cyan-400 border-cyan-500/40 px-2"
          >
            API ENGINE v2.0
          </Badge>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <div className="bg-slate-950/60 border border-slate-800/80 rounded-lg p-4 space-y-3 font-mono text-xs">
            <div className="flex justify-between items-center pb-2 border-b border-slate-800/60">
              <span className="text-slate-400">目標打球日</span>
              <span className="text-cyan-400 font-bold">
                {badmintonForm?.target_date || "未填寫"}
              </span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-slate-800/60">
              <span className="text-slate-400">目標時段</span>
              <span className="text-cyan-400 font-bold">
            ...
            <div className="flex justify-between items-center">
              <span className="text-slate-400">線程火力</span>
          ...
          <div className="bg-cyan-950/20 border border-cyan-800/30 rounded-lg p-3 text-[11px] text-cyan-300 font-mono space-y-1">
